    ...
    return (<>
        <div className="container">
            <div className="max-w-[480px] flex flex-col items-center justify-center mx-auto mb-9 md:mb-12 lg:mb-16">
                ...
                <form className="w-full max-w-[400px] mx-auto flex items-center justify-center flex-col sm:flex-row gap-2 p-0 sm:p-[5px] border-0 sm:border sm:border-solid sm:border-br rounded-lg bg-transparent sm:bg-light shadow-none sm:shadow-search-field transition-all duration-[0.25s] ease-in hover:shadow-hover">
                    <input type="email" placeholder="Enter Your Email" className="w-full focus:outline-none text-xs text-primary rounded-lg py-2 px-4 font-medium border border-solid border-br sm:border-0 bg-transparent sm:bg-light p-0 sm:p-[5px] shadow-search-field sm:shadow-none " />
