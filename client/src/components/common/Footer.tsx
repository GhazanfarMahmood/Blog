    ...
    return (<>
        <div className="container">
            ...
            >
                ...
                <p 
                    className="text-phara text-center my-[10px_22px]"
                >
                    Subscribe to our email newsletter to get the latest posts delivered right to your email.
                </p>
                <form 
                    className="w-full max-w-[400px] flex items-center justify-center flex-col sm:flex-row gap-2 bg-transparent sm:bg-light p-[5px] border-0 sm:border border-solid border-br rounded-lg shadow-none sm:shadow-search-field transition-all duration-[0.25s] ease-in hover:shadow-none sm:hover:shadow-hover"
                >
                    ...
                    />
                    <button type="button" 
                        className="w-full sm:w-fit min-h-10 flex items-center justify-center leading-[1.2] text-light font-bold -tracking-[0.03em] bg-linear-(--linear-bg) p-[10px_18px] rounded-lg cursor-pointer transition-all duration-[0.25s] ease-in hover:shadow-btn-hover"
                    >
                        Subscribe
                    </button>
                </form>
            ...
            >
                ...
                >
                    <div>
                        ...
                        <p 
                            className="max-w-[410px] text-xs text-primary mt-3"
                        >
                        ...
                        <ul 
                            className="flex items-center justify-start mt-2 mb-4 lg:mb-0 -ml-2 *:w-10 *:h-10 *:flex *:items-center *:justify-center [&_img]:transition [&_img]:duration-[0.25s] [&_img]:ease-in [&_img]:filter-(--filter-primary) [&_a]:hover:*:filter-(--filter-secondary)"
                        >
                            <li>
                                <Link href={"/"}>
                ...
                <p 
                    className="text-[12px] text-phara mt-8 lg:mt-4"
                >
